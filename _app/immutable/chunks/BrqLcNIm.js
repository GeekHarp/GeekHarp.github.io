import{A as o}from"./pNtZXZtK.js";import{a as s}from"./Cd_3pRrh.js";var t=(e=>(e.FullTime="Full-time",e.PartTime="Part-time",e.SelfEmployed="Self-employed",e.Freelance="Freelance",e.Contract="Contract",e.Internship="Internship",e))(t||{});const i="Experience",r=[{slug:"",company:"Ufinity Pte Ltd",description:"Creating awesome tools for developers.",contract:t.FullTime,type:"Software Development",period:{from:new Date(2024,1)},skills:s("ts","js"),name:"Software Engineer",color:"red",links:[],logo:o.Ufinity,shortDescription:`
		...
		`},{slug:"open-sourcer",company:"Findjobs",description:"Creating awesome tools for developers.",contract:t.FullTime,type:"Software Development",period:{from:new Date(2019,7),to:new Date(2023,8)},skills:s("ts","js"),name:"Senior Web Developer",color:"blue",links:[],logo:o.Findjobs,shortDescription:`
