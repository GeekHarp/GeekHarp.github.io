import{A as o}from"./RC7AVPgl.js";import{a as s}from"./D9KUofz_.js";var t=(e=>(e.FullTime="Full-time",e.PartTime="Part-time",e.SelfEmployed="Self-employed",e.Freelance="Freelance",e.Contract="Contract",e.Internship="Internship",e))(t||{});const i="Experience",r=[{slug:"",company:"Ufinity Pte Ltd",description:"Creating awesome tools for developers.",contract:t.FullTime,type:"Software Development",period:{from:new Date(2024,1)},skills:s("ts","js"),name:"Software Engineer (Operations)",color:"red",links:[],logo:o.Ufinity,shortDescription:`
		...
		`},{slug:"open-sourcer",company:"Findjobs",description:"Creating awesome tools for developers.",contract:t.FullTime,type:"Software Development",period:{from:new Date(2019,7),to:new Date(2023,8)},skills:s("ts","js"),name:"Senior Full-stack Web Developer",color:"blue",links:[],logo:o.Findjobs,shortDescription:`
		...
		`},{slug:"software-freelance",company:"Applied Materials",description:"Creating awesome applications for customers.",contract:t.FullTime,type:"Software Development",period:{from:new Date(2017,10),to:new Date(2019,0)},skills:s("svelte","ts","sass","css","html","js"),name:"Engineering Technician",color:"red",links:[],logo:o.AppliedMaterials,shortDescription:`
		...
		`}],p={title:i,items:r};export{p as E};
